...
<template>
  ...
  <section class="mb-12 relative overflow-x-clip">
    <div aria-hidden="true" class="pointer-events-none absolute -top-20 left-1/2 -translate-x-1/2 w-56 h-56 md:w-80 md:h-80 rounded-full bg-[#518E45]/20 blur-2xl"></div>
    <div aria-hidden="true" class="pointer-events-none absolute -bottom-20 left-1/2 -translate-x-1/2 w-56 h-56 md:w-80 md:h-80 rounded-full bg-[#F1CA30]/25 blur-2xl"></div>
